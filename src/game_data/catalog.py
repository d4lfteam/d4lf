...
class GameCatalog:
    ...
    def load_data(self) -> None:
        ...
        corrections = cast("dict[str, object]", self._load_json(language_dir / "corrections.json"))
        ...
        self.tooltips = cast("dict[str, object]", self._load_json(language_dir / "tooltips.json"))
        self.aspect_unique_dict = cast("dict[str, object]", self._load_json(language_dir / "uniques.json"))
