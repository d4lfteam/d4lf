...
def load_backend() -> TTSBackend:
    if __import__("sys").platform == "win32":
        from ._backend_windows import WindowsTTSBackend  # ruff:ignore[import-outside-top-level]

        return WindowsTTSBackend()
    from ._backend_noop import NoopTTSBackend  # ruff:ignore[import-outside-top-level]
