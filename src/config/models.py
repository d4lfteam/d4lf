...
class GeneralModel(_IniBaseModel):
    ...
    junk_rares: bool = Field(default=True, description="Should rares be automatically marked as junk even if they match a filter?")
    ...
    vision_mode_coordinates: tuple[int, int] = Field(
