...
PLANNER_API_DATA_URL = "https://assets-ng.maxroll.gg/d4-tools/game/data.min.json?latest"
PLANNER_API_NAMES_DATA_URL = "https://assets-ng.maxroll.gg/d4-tools/game/data.enus.json?latest"
