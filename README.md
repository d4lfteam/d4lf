...
| junk_rares                                        | Which, if any, rare items should be automatically junked during filtering. <br>- `disabled`: Keep normal rare filtering behavior (default) <br>- `3 affixes`: Junk all rare items with exactly 3 affixes (default) <br>- `all`: Junk all rare items even if they match a filter                                                                                                                                                                                    |
