...
| junk_rares                                        | How rares should be automatically junked while filtering. <br>- `disabled`: Keep normal rare filtering behavior (default) <br>- `3 affixes`: Junk only rare items with exactly 3 affixes <br>- `all`: Junk all rare items even if they match a filter                                                                                                                                                                                    |
