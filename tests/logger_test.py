...
def test_apply_log_level_updates_root_and_handlers(isolated_root_logger) -> None:
...
def test_is_configured_requires_file_handler(isolated_root_logger) -> None:
...
def test_apply_log_level_skips_named_handlers(isolated_root_logger) -> None:
...
def test_apply_log_level_is_case_insensitive(isolated_root_logger) -> None:
...
def test_remove_transient_gui_handlers_keeps_file_and_console_output(isolated_root_logger) -> None:
...
def test_default_gui_log_formatter_hides_technical_information_and_timestamp() -> None:
    assert create_formatter(technical=False, timestamp=False).format(_record()) == "item marked junk"


def test_technical_gui_log_formatter_restores_technical_information() -> None:
...
def test_timestamp_gui_log_formatter_restores_timestamp() -> None:
...
def test_startup_log_buffer_captures_and_consumes_records(isolated_root_logger) -> None:
