...
items = [
    ...
    # Nothing wrong with this unique, it's just here as a normal test case
    (
        [
            "ROTTING LIGHTBRINGER",
            "Unique Two-Handed Mace",
            "750 Item Power",
            "523 Damage Per Second (-191)",
            "[466 - 698] Damage per Hit",
            "0.90 Attacks per Second (Slow)",
            "+140.0% Damage to Poisoned Enemies [140.0]%",
            "+20.0% Willpower [16.0 - 25.0]%",
            "+464.0% Poison Damage [450.0 - 550.0]%",
            "+31.4% Chance for Pulverize to Hit Twice [30.0 - 35.0]%",
            "40.0% Resource Cost Reduction [31.0 - 40.0]%",
            "If no puddle is around you, Pulverize forms a puddle that guarantees its own Overpowers and deals 460%[x] [200 - 600]% of its normal damage as Poisoning over 7 seconds. . Pulverizing causes all close puddles to splash 46%[x] [20 - 60]% of their total damage within their areas and around them.",
            "Empty Socket",
            "The Cathedral fled south, leaving sanctums hollow and songs unsung. What was left - stone, silver, and sanctified relics - were claimed and bent to the will of elder root and spirit. -\xa0Bryona",
            "Requires Level 60Druid. Only. Unique Equipped",
            "Sell Value: 204,226 Gold",
            "Durability: 100/100",
            "Right mouse button",
        ],
        Item(
            affixes=[
                ...
                Affix(
                    ...
                    min_value=450.0,
                    name="poison_damage",
                    text="+464.0% Poison Damage [450.0 - 550.0]%",
                    type=AffixType.normal,
                    value=464.0,
                ),
                Affix(
                    max_value=35.0,
                    min_value=30.0,
                    name="chance_for_pulverize_to_hit_twice",
                    text="+31.4% Chance for Pulverize to Hit Twice [30.0 - 35.0]%",
                    type=AffixType.normal,
                    value=31.4,
                ),
                Affix(
                    ...
                    text="40.0% Resource Cost Reduction [31.0 - 40.0]%",
                    type=AffixType.normal,
                    value=40.0,
                ),
            ],
            aspect=Aspect(
                name="rotting_lightbringer",
                min_value=200.0,
                max_value=600.0,
                text="If no puddle is around you, Pulverize forms a puddle that guarantees its own Overpowers and deals 460%[x] [200 - 600]% of its normal damage as Poisoning over 7 seconds. . Pulverizing causes all close puddles to splash 46%[x] [20 - 60]% of their total damage within their areas and around them.",
                value=460.0,
            ),
            codex_upgrade=False,
            cosmetic_upgrade=False,
            inherent=[
                Affix(
                    max_value=140.0,
                    min_value=140.0,
                    name="damage_to_poisoned_enemies",
                    text="+140.0% Damage to Poisoned Enemies [140.0]%",
                    type=AffixType.inherent,
                    value=140.0,
                )
            ],
            ...
            name="rotting_lightbringer",
            original_name="ROTTING LIGHTBRINGER",
            power=750,
