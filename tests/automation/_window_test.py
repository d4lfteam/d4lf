...
def test_window_spec_matches_process_and_window_name(monkeypatch):
...
def test_non_windows_window_adapter_is_safe_for_the_public_interface():
...
def test_windows_window_adapter_selects_windows_backend():
    assert _window._platform_backend.__name__.endswith("_window_backend_windows")
