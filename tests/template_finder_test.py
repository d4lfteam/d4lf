...
def test_parallel_stop_condition_preserves_template_order(mocker):
    ...
    mocker.patch("src.perception._matching._process_template_refs", return_value=[correct_template, false_template])
    ...
    mocker.patch("src.perception._matching._get_cv_result", side_effect=fake_get_cv_result)
    executor = ThreadPoolExecutor(max_workers=2)
    mocker.patch("src.perception._matching.TP", executor)
